              ...
              <div class="card-body">
                ...
                @foreach($users as $i => $alternatif)
                  <tr>
                    ...
                    <td>{{ $alternatif->harga_motor }}</td>
                    <td>{{ $alternatif->kapasitas_mesin }}</td>
                    <td>{{ $alternatif->kapasitas_tangki }}</td>
                    <td>{{ $alternatif->jarak_tempuh }}</td>
                    <td>{{ $alternatif->tahun_pembuatan }}</td>
                    <td>{{ $alternatif->volume_silinder }}</td>
                    <td>
