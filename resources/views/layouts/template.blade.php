...
<head>
  ...
  <title>@yield('judul') - Mbrem Mbrem</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{{asset('/tema/motor/icon.png')}}" rel="icon">
  <link href="{{asset('tema/motor/icon.png')}}" rel="rent-car-icon">
...
<body>
  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="{{url('/')}}" class="logo d-flex align-items-center">
        <img src="{{asset('tema/motor/icon.png')}}" alt="">
        <span>Mbrem Mbrem</span>
      </a>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="{{url('/')}}#about">Contact</a></li>
  ...
  <footer id="footer" class="footer">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-5 col-md-12 footer-info">
            ...
            <p>Kami Menyediakan Motor yang anda inginkan.</p>
            <div class="social-links mt-3">
              <a href="#" class="twitter"><i class="bi bi-twitter"></i></a>
              <a href="#" class="facebook"><i class="bi bi-facebook"></i></a>
              <a href="https://www.instagram.com/nndzlfkr_/"><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
            ...
            <p>
              Jln Kleben <br>
              Kabupaten Tegal, No. 25<br>
              Jawa Tengah <br><br>
              <strong>Phone:</strong>+6285290233878<br>
              <strong>Email:</strong>mbremmbrem@gmail.com<br>
            </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Mbrem Mbrem</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
